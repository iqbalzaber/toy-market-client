...
const CardAllToys = ({toys}) => {
    ...
    return (
        <div className="card w-80 h-96 cursor-pointer  hover:shadow-xl hover:bg-orange-100">
        ...
        <Link to={`/details/${_id}`}><button className="btn btn-outline btn-success btn-sm">Details</button></Link>
